...
const criptCurrencyDictionary: Dictionary = {
    ...
    getCriptoCompareCriptoCurrenciesTimeStamps: async (currency: string): Promise<CriptoCurrencyTimeStampResponse> => APICall.get(`api/data/v2/histoday?fsym=${currency}&tsym=USD&limit=10`, CriptoCurrencyTimeStampResponse) as unknown as CriptoCurrencyTimeStampResponse,
